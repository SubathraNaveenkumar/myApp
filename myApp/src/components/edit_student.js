...
class edit_student extends Component {
    ...
    constructor(props) {
        ...
        findStudent = data.studentsData.filter(result => result.studname.indexOf(split_id) !== -1)

        this.state.currentStudentData = findStudent[0];
        this.state.id = findStudent[0].id
        this.state.sec = findStudent[0].sec
        this.state.tutor = findStudent[0].tutor
        this.state.name = findStudent[0].name
        this.state.studname = findStudent[0].studname
        this.state.studpass = findStudent[0].studpass
        this.state.f_name = findStudent[0].f_name
        this.state.m_name = findStudent[0].m_name
        this.state.address = findStudent[0].address
    ...
    onSubmit = (e) => {
        ...
        const findIndex = data.studentsData.map(e => e.studname).indexOf(split_id);
        ...
        else
        {
            ...
            const profile = JSON.parse(localStorage.getItem('data_student'));
            profile.studentsData.splice(findIndex,1,this.state.currentStudentData)
            this.setState({
                studentsData: profile.studentsData
            })
                        ...
                        <div className='container flex'>
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div>
                                    ...
                                    <select className='form-control cursor-pointer' name='id' defaultValue={this.state.id} onChange={this.onChangeEvent}>
                                        <option>C1</option>
                                        <option>C2</option>
                                        <option>C3</option>
                                        <option>C4</option>
                                ...
                                <div>
                                    ...
                                    <select className='form-control cursor-pointer' onChange={this.onChangeEvent} name='sec' defaultValue={this.state.sec}>
                                ...
                                <div>
                                    <label>Tutor</label>
                                    <input type='text' className='form-control' name='tutor' maxLength = '20' defaultValue={this.state.tutor} onChange={this.onChangeEvent}></input>
                                ...
                                <div>
                                    ...
                                    <input type='text' className='form-control' name='studname' maxLength = '20' defaultValue={this.state.studname} onChange={this.onChangeEvent}></input>
                                    <label className='text-danger'>{this.state.studuser_error}</label>
                                </div>
                                <div>
                                    <label>Password</label>
                                    <input type='text' className='form-control' name='studpass'  maxLength = '20'defaultValue={this.state.studpass} onChange={this.onChangeEvent}></input>
                                    <label className='text-danger'>{this.state.studpass_error}</label>
                                </div>
                                <div>
                                    <label>Father's Name</label>
                                    <input type='text' className='form-control' name='f_name' maxLength = '20' defaultValue={this.state.f_name} onChange={this.onChangeEvent}></input>
                                    <label className='text-danger'>{this.state.fname_error}</label>
                                </div>
                                <div>
                                    <label>Mother's Name</label>
                                    <input type='text' className='form-control' name='m_name' maxLength = '20' defaultValue={this.state.m_name} onChange={this.onChangeEvent}></input>
                                    <label className='text-danger'>{this.state.mname_error}</label>
                                </div>
                                <div>
                                    <label>Address</label>
                                    <textarea className='form-control' name='address' resize='none' defaultValue={this.state.address} onChange={this.onChangeEvent}></textarea>
                                ...
                                <div className='btn-grp'>
                                    ...
                                    <button className='btn btn-primary m-b-5 text-light'>Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
